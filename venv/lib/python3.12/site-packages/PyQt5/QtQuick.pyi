...
class QQuickItem(QtCore.QObject, QtQml.QQmlParserStatus):
    ...
    def mapFromItem(
        self,
        item: typing.Optional["QQuickItem"],
...
class QQuickFramebufferObject(QQuickItem):
    class Renderer(PyQt5.sip.wrapper):
        ...
        def framebufferObject(
            self,
        ) -> typing.Optional[QtGui.QOpenGLFramebufferObject]: ...
        def synchronize(
...
class QQuickWindow(QtGui.QWindow):
    ...
    def createTextureFromNativeObject(
        ...
        nativeObjectPtr: typing.Optional[PyQt5.sip.voidptr],
        nativeLayout: int,
        size: QtCore.QSize,
...
class QSGNode(PyQt5.sip.wrapper):
    ...
    class Flags(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QSGNode.Flags", "QSGNode.Flag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QSGMaterialShader(PyQt5.sip.wrapper):
    ...
    def setShaderSourceFiles(
        ...
        sourceFiles: typing.Iterable[typing.Optional[str]],
    ) -> None: ...
    def setShaderSourceFile(
        ...
        sourceFile: typing.Optional[str],
    ) -> None: ...
...
class QSGMaterialRhiShader(QSGMaterialShader):
    ...
    class GraphicsPipelineState(PyQt5.sipsimplewrapper):
        ...
        class ColorMaskComponent(int):
            R = (
                ...
            )  # type: QSGMaterialRhiShader.GraphicsPipelineState.ColorMaskComponent
            G = (
                ...
            )  # type: QSGMaterialRhiShader.GraphicsPipelineState.ColorMaskComponent
            B = (
        ...
        class BlendFactor(int):
            ...
            SrcColor = (
                ...
            )  # type: QSGMaterialRhiShader.GraphicsPipelineState.BlendFactor
            OneMinusSrcColor = (
                ...
            )  # type: QSGMaterialRhiShader.GraphicsPipelineState.BlendFactor
            DstColor = (
        ...
        @typing.overload
        def __init__(
            self, a0: "QSGMaterialRhiShader.GraphicsPipelineState"
        ) -> None: ...
    ...
    def updateGraphicsPipelineState(
        ...
        ps: typing.Optional["QSGMaterialRhiShader.GraphicsPipelineState"],
        newMaterial: typing.Optional[QSGMaterial],
        oldMaterial: typing.Optional[QSGMaterial],
    ) -> bool: ...
