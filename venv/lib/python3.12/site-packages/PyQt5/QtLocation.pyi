...
class QGeoCodeReply(QtCore.QObject):
    ...
    def __init__(
        ...
        errorString: typing.Optional[str],
    ...
    def setError(
        self, error: "QGeoCodeReply.Error", errorString: typing.Optional[str]
    ) -> None: ...
...
class QGeoCodingManager(QtCore.QObject):
    ...
    def geocode(
        self,
        searchString: typing.Optional[str],
        limit: int = ...,
        offset: int = ...,
        bounds: QtPositioning.QGeoShape = ...,
    ) -> typing.Optional[QGeoCodeReply]: ...
...
class QGeoRouteReply(QtCore.QObject):
    ...
    def setFinished(self, finished: bool) -> None: ...
    def setError(
        self, error: "QGeoRouteReply.Error", errorString: typing.Optional[str]
    ) -> None: ...
    finished: typing.ClassVar[QtCore.pyqtSignal]
    aborted: typing.ClassVar[QtCore.pyqtSignal]
    def abort(self) -> None: ...
...
class QGeoRoutingManager(QtCore.QObject):
    ...
    ) -> typing.Optional[QGeoRouteReply]: ...
    def calculateRoute(
        self, request: QGeoRouteRequest
    ) -> typing.Optional[QGeoRouteReply]: ...
    def managerVersion(self) -> int: ...
    def managerName(self) -> str: ...
...
class QPlace(PyQt5.sipsimplewrapper):
    ...
    def appendContactDetail(
        self, contactType: typing.Optional[str], detail: "QPlaceContactDetail"
    ) -> None: ...
    def setContactDetails(
        self,
        contactType: typing.Optional[str],
        details: typing.Iterable["QPlaceContactDetail"],
    ) -> None: ...
    def contactDetails(
        self, contactType: typing.Optional[str]
    ...
    def setExtendedAttribute(
        self, attributeType: typing.Optional[str], attribute: "QPlaceAttribute"
    ) -> None: ...
    def extendedAttribute(
        self, attributeType: typing.Optional[str]
    ) -> "QPlaceAttribute": ...
...
class QPlaceReply(QtCore.QObject):
    ...
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    def setError(
        self, error: "QPlaceReply.Error", errorString: typing.Optional[str]
    ) -> None: ...
    def setFinished(self, finished: bool) -> None: ...
...
class QPlaceManager(QtCore.QObject):
    ...
    finished: typing.ClassVar[QtCore.pyqtSignal]
    def matchingPlaces(
        self, request: "QPlaceMatchRequest"
    ) -> typing.Optional["QPlaceMatchReply"]: ...
    ...
    def childCategories(
        self, parentId: typing.Optional[str] = ...
    ) -> typing.List[QPlaceCategory]: ...
    def category(self, categoryId: typing.Optional[str]) -> QPlaceCategory: ...
    def childCategoryIds(
        self, parentId: typing.Optional[str] = ...
    ) -> typing.List[str]: ...
    def parentCategoryId(self, categoryId: typing.Optional[str]) -> str: ...
    def initializeCategories(self) -> typing.Optional[QPlaceReply]: ...
    def removeCategory(
        self, categoryId: typing.Optional[str]
    ) -> typing.Optional[QPlaceIdReply]: ...
    def saveCategory(
        self, category: QPlaceCategory, parentId: typing.Optional[str] = ...
    ) -> typing.Optional[QPlaceIdReply]: ...
    def removePlace(
        self, placeId: typing.Optional[str]
    ) -> typing.Optional[QPlaceIdReply]: ...
    def savePlace(self, place: QPlace) -> typing.Optional[QPlaceIdReply]: ...
    def searchSuggestions(
        self, request: "QPlaceSearchRequest"
    ) -> typing.Optional["QPlaceSearchSuggestionReply"]: ...
    def search(
        self, query: "QPlaceSearchRequest"
    ) -> typing.Optional["QPlaceSearchReply"]: ...
    def getPlaceContent(
        self, request: QPlaceContentRequest
    ) -> typing.Optional[QPlaceContentReply]: ...
    def getPlaceDetails(
        self, placeId: typing.Optional[str]
    ) -> typing.Optional[QPlaceDetailsReply]: ...
    def managerVersion(self) -> int: ...
    def managerName(self) -> str: ...
...
class QPlaceSearchSuggestionReply(QPlaceReply):
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    def setSuggestions(
        self, suggestions: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
    def type(self) -> QPlaceReply.Type: ...
