...
class QGLContext(PyQt5.sip.wrapper):
    ...
    @staticmethod
    def areSharing(
        context1: typing.Optional["QGLContext"], context2: typing.Optional["QGLContext"]
    ) -> bool: ...
...
class QGLWidget(QtWidgets.QWidget):
    ...
    def __init__(
        self,
        context: typing.Optional[QGLContext],
        parent: typing.Optional[QtWidgets.QWidget] = ...,
        shareWidget: typing.Optional["QGLWidget"] = ...,
        flags: typing.Union[QtCore.Qt.WindowFlags, QtCore.Qt.WindowType] = ...,
    ) -> None: ...
    ...
    @typing.overload
    def renderText(
        self, x: int, y: int, str: typing.Optional[str], font: QtGui.QFont = ...
    ) -> None: ...
    @typing.overload
    def renderText(
        self,
