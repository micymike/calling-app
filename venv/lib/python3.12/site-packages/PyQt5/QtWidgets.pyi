...
class QWidget(QtCore.QObject, QtGui.QPaintDevice):
    ...
    class RenderFlags(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QWidget.RenderFlags", "QWidget.RenderFlag"]
        ) -> None: ...
    ...
    def nativeEvent(
        self,
        eventType: typing.Union[QtCore.QByteArray, bytes, bytearray],
        message: typing.Optional[PyQt5.sip.voidptr],
    ...
    def render(
        ...
        flags: typing.Union["QWidget.RenderFlags", "QWidget.RenderFlag"] = ...,
    ) -> None: ...
    @typing.overload
    def render(
        self,
    ...
    def restoreGeometry(
        self, geometry: typing.Union[QtCore.QByteArray, bytes, bytearray]
    ) -> bool: ...
    ...
    def overrideWindowFlags(
        self, type: typing.Union[QtCore.Qt.WindowFlags, QtCore.Qt.WindowType]
    ) -> None: ...
    def setWindowFlags(
        self, type: typing.Union[QtCore.Qt.WindowFlags, QtCore.Qt.WindowType]
    ) -> None: ...
    ...
    def insertActions(
        self, before: typing.Optional["QAction"], actions: typing.Iterable["QAction"]
    ) -> None: ...
    def insertAction(
        self, before: typing.Optional["QAction"], action: typing.Optional["QAction"]
    ) -> None: ...
    ...
    def overrideWindowState(
        self, state: typing.Union[QtCore.Qt.WindowStates, QtCore.Qt.WindowState]
    ) -> None: ...
    def setWindowState(
        self, state: typing.Union[QtCore.Qt.WindowStates, QtCore.Qt.WindowState]
    ) -> None: ...
...
class QLayout(QtCore.QObject, QLayoutItem):
    ...
    def setAlignment(
        self,
        w: typing.Optional[QWidget],
        alignment: typing.Union[QtCore.Qt.Alignment, QtCore.Qt.AlignmentFlag],
    ) -> bool: ...
    @typing.overload
    def setAlignment(
        self,
        l: typing.Optional["QLayout"],
        alignment: typing.Union[QtCore.Qt.Alignment, QtCore.Qt.AlignmentFlag],
    ) -> bool: ...
    @typing.overload
    def setAlignment(
...
class QComboBox(QWidget):
    ...
    def insertItems(
        self, index: int, texts: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
    @typing.overload
    def insertItem(
...
class QStyle(QtCore.QObject):
    ...
    class State(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QStyle.State", "QStyle.StateFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QCompleter(QtCore.QObject):
    ...
    def __init__(
        self,
        list: typing.Iterable[typing.Optional[str]],
        parent: typing.Optional[QtCore.QObject] = ...,
    ) -> None: ...
    @typing.overload
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
...
class QDirModel(QtCore.QAbstractItemModel):
    ...
    def __init__(
        self,
        nameFilters: typing.Iterable[typing.Optional[str]],
    ...
    def setNameFilters(
        self, filters: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
    def iconProvider(self) -> typing.Optional["QFileIconProvider"]: ...
    def setIconProvider(
        self, provider: typing.Optional["QFileIconProvider"]
    ) -> None: ...
...
class QFileDialog(QDialog):
    ...
    def setSupportedSchemes(
        self, schemes: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
    @staticmethod
    def getSaveFileUrl(
        parent: typing.Optional[QWidget] = ...,
        ...
        supportedSchemes: typing.Iterable[typing.Optional[str]] = ...,
...
class QGraphicsOpacityEffect(QGraphicsEffect):
    ...
    def setOpacityMask(
        ...
        mask: typing.Union[
            QtGui.QBrush,
            typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor],
            QtGui.QGradient,
        ],
    ) -> None: ...
...
class QAbstractGraphicsShapeItem(QGraphicsItem):
    ...
    def setPen(
        self,
        pen: typing.Union[
            QtGui.QPen, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor]
        ],
    ) -> None: ...
...
class QInputDialog(QDialog):
    ...
    def setComboBoxItems(
        self, items: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
    ...
    def getItem(
        ...
        title: typing.Optional[str],
        label: typing.Optional[str],
        items: typing.Iterable[typing.Optional[str]],
        current: int = ...,
        editable: bool = ...,
        flags: typing.Union[QtCore.Qt.WindowFlags, QtCore.Qt.WindowType] = ...,
        inputMethodHints: typing.Union[
...
class QLineEdit(QWidget):
    ...
    @typing.overload
    def addAction(
        self, action: typing.Optional[QAction], position: "QLineEdit.ActionPosition"
    ) -> None: ...
    @typing.overload
    def addAction(
...
class QListWidget(QListView):
    ...
    def mimeData(
        self, items: typing.Iterable[QListWidgetItem]
    ) -> typing.Optional[QtCore.QMimeData]: ...
    def mimeTypes(self) -> typing.List[str]: ...
    ...
    def insertItems(
        self, row: int, labels: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
    @typing.overload
...
class QMenu(QWidget):
    ...
    @typing.overload
    def insertSection(
        self, before: typing.Optional[QAction], text: typing.Optional[str]
    ) -> typing.Optional[QAction]: ...
    @typing.overload
    def insertSection(
        self,
    ...
    def clear(self) -> None: ...
    def insertSeparator(
        self, before: typing.Optional[QAction]
    ) -> typing.Optional[QAction]: ...
    def insertMenu(
        self, before: typing.Optional[QAction], menu: typing.Optional["QMenu"]
    ) -> typing.Optional[QAction]: ...
...
class QMenuBar(QWidget):
    ...
    @typing.overload
    def addAction(
        self, text: typing.Optional[str], slot: PYQT_SLOT
    ) -> typing.Optional[QAction]: ...
...
class QStyleOptionFrame(QStyleOption):
    ...
    features = (
        ...
    )  # type: typing.Union['QStyleOptionFrame.FrameFeatures', 'QStyleOptionFrame.FrameFeature']
...
class QStyleOptionHeader(QStyleOption):
    ...
    iconAlignment = (
        ...
    )  # type: typing.Union[QtCore.Qt.Alignment, QtCore.Qt.AlignmentFlag]
...
class QStyleOptionButton(QStyleOption):
    ...
    features = (
        ...
    )  # type: typing.Union['QStyleOptionButton.ButtonFeatures', 'QStyleOptionButton.ButtonFeature']
    icon = ...  # type: QtGui.QIcon
...
class QStyleOptionTab(QStyleOption):
    ...
    cornerWidgets = (
        ...
    )  # type: typing.Union['QStyleOptionTab.CornerWidgets', 'QStyleOptionTab.CornerWidget']
    documentMode = ...  # type: bool
    features = (
        ...
    )  # type: typing.Union['QStyleOptionTab.TabFeatures', 'QStyleOptionTab.TabFeature']
    icon = ...  # type: QtGui.QIcon
    iconSize = ...  # type: QtCore.QSize
...
class QStyleOptionViewItem(QStyleOption):
    ...
    backgroundBrush = (
        ...
    )  # type: typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor], QtGui.QGradient]
    ...
    features = (
        ...
    )  # type: typing.Union['QStyleOptionViewItem.ViewItemFeatures', 'QStyleOptionViewItem.ViewItemFeature']
    font = ...  # type: QtGui.QFont
    icon = ...  # type: QtGui.QIcon
...
class QStyleOptionSpinBox(QStyleOptionComplex):
    ...
    stepEnabled = (
        ...
    )  # type: typing.Union[QAbstractSpinBox.StepEnabled, QAbstractSpinBox.StepEnabledFlag]
...
class QStyleOptionToolButton(QStyleOptionComplex):
    ...
    features = (
        ...
    )  # type: typing.Union['QStyleOptionToolButton.ToolButtonFeatures', 'QStyleOptionToolButton.ToolButtonFeature']
    font = ...  # type: QtGui.QFont
    icon = ...  # type: QtGui.QIcon
    iconSize = ...  # type: QtCore.QSize
...
class QStyleOptionTitleBar(QStyleOptionComplex):
    ...
    titleBarFlags = (
        ...
    )  # type: typing.Union[QtCore.Qt.WindowFlags, QtCore.Qt.WindowType]
...
class QStyleOptionToolBar(QStyleOption):
    ...
    features = (
        ...
    )  # type: typing.Union['QStyleOptionToolBar.ToolBarFeatures', 'QStyleOptionToolBar.ToolBarFeature']
    lineWidth = ...  # type: int
    midLineWidth = ...  # type: int
...
class QTabBar(QWidget):
    ...
    def setTabTextColor(
        self, index: int, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor]
    ) -> None: ...
...
class QTableWidget(QTableView):
    ...
    def mimeData(
        self, items: typing.Iterable[QTableWidgetItem]
    ) -> typing.Optional[QtCore.QMimeData]: ...
    def mimeTypes(self) -> typing.List[str]: ...
    ...
    def setHorizontalHeaderLabels(
        self, labels: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
...
class QToolBar(QWidget):
    ...
    def setIconSize(self, iconSize: QtCore.QSize) -> None: ...
    def widgetForAction(
        self, action: typing.Optional[QAction]
    ) -> typing.Optional[QWidget]: ...
    def toolButtonStyle(self) -> QtCore.Qt.ToolButtonStyle: ...
    def iconSize(self) -> QtCore.QSize: ...
    def toggleViewAction(self) -> typing.Optional[QAction]: ...
    ...
    def insertWidget(
        self, before: typing.Optional[QAction], widget: typing.Optional[QWidget]
    ) -> typing.Optional[QAction]: ...
    def addWidget(
        self, widget: typing.Optional[QWidget]
    ) -> typing.Optional[QAction]: ...
    ...
    @typing.overload
    def addAction(
        self, icon: QtGui.QIcon, text: typing.Optional[str], slot: PYQT_SLOT
    ) -> typing.Optional[QAction]: ...
    def clear(self) -> None: ...
    def orientation(self) -> QtCore.Qt.Orientation: ...
    def setOrientation(self, orientation: QtCore.Qt.Orientation) -> None: ...
...
class QTreeWidgetItem(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def __init__(
        self, strings: typing.Iterable[typing.Optional[str]], type: int = ...
    ) -> None: ...
    @typing.overload
    def __init__(
    ...
    def __init__(
        ...
        strings: typing.Iterable[typing.Optional[str]],
        type: int = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        parent: typing.Optional["QTreeWidget"],
        preceding: typing.Optional["QTreeWidgetItem"],
        type: int = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
...
class QTreeWidget(QTreeView):
    ...
    def setFirstItemColumnSpanned(
        self, item: typing.Optional[QTreeWidgetItem], span: bool
    ) -> None: ...
    ...
    def mimeData(
        self, items: typing.Iterable[QTreeWidgetItem]
    ) -> typing.Optional[QtCore.QMimeData]: ...
    def mimeTypes(self) -> typing.List[str]: ...
    itemSelectionChanged: typing.ClassVar[QtCore.pyqtSignal]
    currentItemChanged: typing.ClassVar[QtCore.pyqtSignal]
...
class QUndoView(QListView):
    ...
    @typing.overload
    def __init__(
        self, stack: typing.Optional[QUndoStack], parent: typing.Optional[QWidget] = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self, group: typing.Optional[QUndoGroup], parent: typing.Optional[QWidget] = ...
    ) -> None: ...
...
class QWizard(QDialog):
    ...
    def setButtonLayout(
        self, layout: typing.Iterable["QWizard.WizardButton"]
    ) -> None: ...
...
def qDrawPlainRect(
    ...
    w: int,
    h: int,
    a5: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor],
    lineWidth: int = ...,
...
def qDrawPlainRect(
    p: typing.Optional[QtGui.QPainter],
    r: QtCore.QRect,
    a2: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor],
    lineWidth: int = ...,
    fill: typing.Optional[
        typing.Union[
            QtGui.QBrush,
