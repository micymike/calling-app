...
class QPixmap(QPaintDevice):
    ...
    def loadFromData(
        self,
        buf: typing.Optional[PyQt5.sip.array[bytes]],
        format: typing.Optional[str] = ...,
        flags: typing.Union[
            QtCore.Qt.ImageConversionFlags, QtCore.Qt.ImageConversionFlag
        ] = ...,
...
class QBrush(PyQt5.sipsimplewrapper):
    ...
    def __init__(
        self,
        brush: typing.Union[
            "QBrush", typing.Union[QColor, QtCore.Qt.GlobalColor], "QGradient"
        ],
    ) -> None: ...
    @typing.overload
    def __init__(self, variant: typing.Any) -> None: ...
...
class QDesktopServices(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def setUrlHandler(
        scheme: typing.Optional[str], method: typing.Callable[[QtCore.QUrl], None]
    ) -> None: ...
    @staticmethod
...
class QNativeGestureEvent(QInputEvent):
    ...
    def __init__(
        self,
        type: QtCore.Qt.NativeGestureType,
        dev: typing.Optional["QTouchDevice"],
        localPos: typing.Union[QtCore.QPointF, QtCore.QPoint],
        windowPos: typing.Union[QtCore.QPointF, QtCore.QPoint],
        screenPos: typing.Union[QtCore.QPointF, QtCore.QPoint],
        value: float,
...
class QFont(PyQt5.sipsimplewrapper):
    ...
    def insertSubstitutions(
        a0: typing.Optional[str], a1: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
    @staticmethod
...
class QFontDatabase(PyQt5.sipsimplewrapper):
    ...
    def weight(
        self, family: typing.Optional[str], style: typing.Optional[str]
    ) -> int: ...
    def bold(
        self, family: typing.Optional[str], style: typing.Optional[str]
    ) -> bool: ...
    ...
    def font(
        self, family: typing.Optional[str], style: typing.Optional[str], pointSize: int
    ) -> QFont: ...
    @typing.overload
    ...
    @typing.overload
    def writingSystems(
        self, family: typing.Optional[str]
...
class QFontMetrics(PyQt5.sipsimplewrapper):
    ...
    def size(
        ...
        text: typing.Optional[str],
        tabStops: int = ...,
        tabArray: typing.Optional[typing.List[int]] = ...,
    ) -> QtCore.QSize: ...
    @typing.overload
...
class QIcon(PyQt5.sip.wrapper):
    ...
    def setThemeSearchPaths(
        searchpath: typing.Iterable[typing.Optional[str]],
    ) -> None: ...
    @staticmethod
...
class QImage(QPaintDevice):
    ...
    def __init__(
        self,
        data: typing.Optional[PyQt5.sip.voidptr],
        width: int,
        height: int,
        format: "QImage.Format",
    ) -> None: ...
...
class QOpenGLBuffer(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def allocate(
        self, data: typing.Optional[PyQt5.sip.voidptr], count: int
    ) -> None: ...
    @typing.overload
    def allocate(self, count: int) -> None: ...
    def write(
        self, offset: int, data: typing.Optional[PyQt5.sip.voidptr], count: int
    ) -> None: ...
    def read(
        self, offset: int, data: typing.Optional[PyQt5.sip.voidptr], count: int
    ) -> bool: ...
...
class QOpenGLShaderProgram(QtCore.QObject):
    ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: "QVector2D"
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: "QVector3D"
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: "QVector4D"
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self,
    ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QMatrix2x2
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QMatrix2x3
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QMatrix2x4
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QMatrix3x2
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QMatrix3x3
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QMatrix3x4
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QMatrix4x2
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QMatrix4x3
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QMatrix4x4
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: "QTransform"
    ) -> None: ...
    @typing.overload
    def uniformLocation(
    ...
    def setAttributeValue(
        self,
        name: typing.Optional[str],
        value: typing.Union[QColor, QtCore.Qt.GlobalColor],
    ) -> None: ...
    @typing.overload
...
class QOpenGLWindow(QPaintDeviceWindow):
    ...
    def __init__(
        self,
        shareContext: typing.Optional[QOpenGLContext],
        updateBehavior: "QOpenGLWindow.UpdateBehavior" = ...,
        parent: typing.Optional[QWindow] = ...,
    ) -> None: ...
    def metric(self, metric: QPaintDevice.PaintDeviceMetric) -> int: ...
...
class QPainter(PyQt5.sipsimplewrapper):
    ...
    def drawPixmapFragments(
        self,
        fragments: typing.Optional[PyQt5.sip.array["QPainter.PixmapFragment"]],
        pixmap: QPixmap,
    ...
    def fillRect(
        ...
        w: int,
        h: int,
        b: typing.Union[QBrush, typing.Union[QColor, QtCore.Qt.GlobalColor], QGradient],
    ) -> None: ...
    @typing.overload
    def fillRect(
    ...
    @typing.overload
    def drawText(
        self, p: typing.Union[QtCore.QPointF, QtCore.QPoint], s: typing.Optional[str]
    ) -> None: ...
    @typing.overload
    def drawText(
    ...
    def drawConvexPolygon(
        ...
        points: typing.Optional[
            PyQt5.sip.array[typing.Union[QtCore.QPointF, QtCore.QPoint]]
        ],
    ) -> None: ...
    @typing.overload
    def drawConvexPolygon(
        self,
        point: typing.Optional[typing.Union[QtCore.QPointF, QtCore.QPoint]],
        *args: typing.Union[QtCore.QPointF, QtCore.QPoint]
    ) -> None: ...
    @typing.overload
    def drawConvexPolygon(
        self, points: typing.Optional[PyQt5.sip.array[QtCore.QPoint]]
    ) -> None: ...
    @typing.overload
    def drawConvexPolygon(
    ...
    def drawPolygon(
        self,
        points: typing.Optional[PyQt5.sip.array[QtCore.QPoint]],
        fillRule: QtCore.Qt.FillRule = ...,
    ) -> None: ...
    @typing.overload
    def drawPolygon(
    ...
    @typing.overload
    def drawRects(
        self, rects: typing.Optional[PyQt5.sip.array[QtCore.QRectF]]
    ) -> None: ...
    @typing.overload
    def drawRects(
    ...
    @typing.overload
    def drawRects(
        self, rects: typing.Optional[PyQt5.sip.array[QtCore.QRect]]
    ) -> None: ...
    @typing.overload
    def drawRects(
    ...
    @typing.overload
    def drawLines(
        self, lines: typing.Optional[PyQt5.sip.array[QtCore.QLineF]]
    ) -> None: ...
    @typing.overload
    def drawLines(
    ...
    def drawLines(
        self,
        pointPair: typing.Optional[typing.Union[QtCore.QPointF, QtCore.QPoint]],
        *args: typing.Union[QtCore.QPointF, QtCore.QPoint]
    ) -> None: ...
    @typing.overload
    def drawLines(
        self, lines: typing.Optional[PyQt5.sip.array[QtCore.QLine]]
    ) -> None: ...
    @typing.overload
    def drawLines(
    ...
    @typing.overload
    def drawLines(
        self, pointPairs: typing.Optional[PyQt5.sip.array[QtCore.QPoint]]
    ) -> None: ...
    @typing.overload
    def drawLines(
    ...
    def strokePath(
        self,
        path: "QPainterPath",
        pen: typing.Union["QPen", typing.Union[QColor, QtCore.Qt.GlobalColor]],
    ) -> None: ...
    ...
    @typing.overload
    def setPen(
        self, pen: typing.Union["QPen", typing.Union[QColor, QtCore.Qt.GlobalColor]]
    ) -> None: ...
    @typing.overload
...
class QPicture(QPaintDevice):
    ...
    @typing.overload
    def save(
        self, dev: typing.Optional[QtCore.QIODevice], format: typing.Optional[str] = ...
    ) -> bool: ...
    @typing.overload
    def save(
        self, fileName: typing.Optional[str], format: typing.Optional[str] = ...
...
class QPictureIO(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, ioDevice: typing.Optional[QtCore.QIODevice], format: typing.Optional[str]
    ) -> None: ...
    @typing.overload
    def __init__(
        self, fileName: typing.Optional[str], format: typing.Optional[str]
...
class QSessionManager(QtCore.QObject):
    ...
    @typing.overload
    def setManagerProperty(
        self, name: typing.Optional[str], value: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
...
class QTextDocumentFragment(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def fromHtml(
        html: typing.Optional[str], resourceProvider: typing.Optional[QTextDocument]
...
class QTextCharFormat(QTextFormat):
    ...
    def setFontFamilies(
        self, families: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
