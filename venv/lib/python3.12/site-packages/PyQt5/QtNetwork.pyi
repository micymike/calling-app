...
class QHostAddress(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def parseSubnet(
        subnet: typing.Optional[str],
    ) -> typing.Tuple["QHostAddress", int]: ...
...
class QHttpPart(PyQt5.sipsimplewrapper):
    ...
    def setBody(
        self, body: typing.Union[QtCore.QByteArray, bytes, bytearray]
    ) -> None: ...
    def setRawHeader(
        self,
...
class QNetworkReply(QtCore.QIODevice):
    ...
    def ignoreSslErrorsImplementation(
        self, a0: typing.Iterable["QSslError"]
    ) -> None: ...
...
class QNetworkSession(QtCore.QObject):
    ...
    def setSessionProperty(
        self, key: typing.Optional[str], value: typing.Any
    ) -> None: ...
...
class QSslCertificate(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def verify(
        certificateChain: typing.Iterable["QSslCertificate"],
        hostName: typing.Optional[str] = ...,
...
class QSslConfiguration(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def addCaCertificates(
        self, certificates: typing.Iterable[QSslCertificate]
    ) -> None: ...
    ...
    def setEllipticCurves(
        self, curves: typing.Iterable["QSslEllipticCurve"]
    ) -> None: ...
...
class QSslKey(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, handle: typing.Optional[PyQt5.sip.voidptr], type: QSsl.KeyType = ...
    ) -> None: ...
    @typing.overload
