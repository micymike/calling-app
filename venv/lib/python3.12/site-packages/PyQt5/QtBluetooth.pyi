...
class QBluetoothDeviceInfo(PyQt5.sip.wrapper):
    ...
    def serviceUuids(
        ...
        typing.List["QBluetoothUuid"],
        typing.Optional["QBluetoothDeviceInfo.DataCompleteness"],
    ]: ...
    @typing.overload
    def setServiceUuids(
        self,
...
class QBluetoothTransferManager(QtCore.QObject):
    ...
    ) -> typing.Optional["QBluetoothTransferReply"]: ...
...
class QBluetoothTransferReply(QtCore.QObject):
    ...
    def setManager(
        self, manager: typing.Optional[QBluetoothTransferManager]
    ) -> None: ...
