...
class QDomNode(PyQt5.sipsimplewrapper):
    ...
    def nextSiblingElement(
        self, taName: typing.Optional[str] = ...
    ) -> "QDomElement": ...
    def previousSiblingElement(
        self, tagName: typing.Optional[str] = ...
    ) -> "QDomElement": ...
...
class QDomDocument(QDomNode):
    ...
    @typing.overload
    def setContent(
        self, source: typing.Optional["QXmlInputSource"], namespaceProcessing: bool
    ) -> typing.Tuple[
        bool, typing.Optional[str], typing.Optional[int], typing.Optional[int]
    ]: ...
    @typing.overload
    ...
    @typing.overload
    def setContent(
        self, dev: typing.Optional[QtCore.QIODevice]
    ) -> typing.Tuple[
        bool, typing.Optional[str], typing.Optional[int], typing.Optional[int]
    ]: ...
    @typing.overload
    def setContent(
        self,
        source: typing.Optional["QXmlInputSource"],
        reader: typing.Optional["QXmlReader"],
    ) -> typing.Tuple[
        bool, typing.Optional[str], typing.Optional[int], typing.Optional[int]
    ]: ...
    @typing.overload
...
class QXmlAttributes(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def value(
        self, uri: typing.Optional[str], localName: typing.Optional[str]
    ) -> str: ...
    @typing.overload
    ...
    @typing.overload
    def index(
        self, uri: typing.Optional[str], localPart: typing.Optional[str]
    ) -> int: ...
...
class QXmlInputSource(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def setData(
        self, dat: typing.Union[QtCore.QByteArray, bytes, bytearray]
    ) -> None: ...
...
class QXmlReader(PyQt5.sipsimplewrapper):
    ...
    def setLexicalHandler(
        self, handler: typing.Optional["QXmlLexicalHandler"]
    ) -> None: ...
    ...
    def setContentHandler(
        self, handler: typing.Optional["QXmlContentHandler"]
    ) -> None: ...
    ...
    def setEntityResolver(
        self, handler: typing.Optional["QXmlEntityResolver"]
    ) -> None: ...
    def hasProperty(self, name: typing.Optional[str]) -> bool: ...
    def setProperty(
        self, name: typing.Optional[str], value: typing.Optional[PyQt5.sip.voidptr]
    ) -> None: ...
    def property(
        self, name: typing.Optional[str]
    ) -> typing.Tuple[typing.Optional[PyQt5.sip.voidptr], typing.Optional[bool]]: ...
...
class QXmlSimpleReader(QXmlReader):
    ...
    @typing.overload
    def parse(
        self, input: typing.Optional[QXmlInputSource], incremental: bool
    ) -> bool: ...
    def declHandler(self) -> typing.Optional["QXmlDeclHandler"]: ...
    def setDeclHandler(self, handler: typing.Optional["QXmlDeclHandler"]) -> None: ...
    def lexicalHandler(self) -> typing.Optional["QXmlLexicalHandler"]: ...
...
class QXmlContentHandler(PyQt5.sipsimplewrapper):
    ...
    def startPrefixMapping(
        self, prefix: typing.Optional[str], uri: typing.Optional[str]
    ) -> bool: ...
...
class QXmlDTDHandler(PyQt5.sipsimplewrapper):
    ...
    def unparsedEntityDecl(
        ...
        publicId: typing.Optional[str],
        systemId: typing.Optional[str],
        notationName: typing.Optional[str],
    ) -> bool: ...
    def notationDecl(
        self,
        name: typing.Optional[str],
...
class QXmlEntityResolver(PyQt5.sipsimplewrapper):
    ...
    def errorString(self) -> str: ...
    def resolveEntity(
        self, publicId: typing.Optional[str], systemId: typing.Optional[str]
    ) -> typing.Tuple[bool, typing.Optional[QXmlInputSource]]: ...
...
class QXmlDeclHandler(PyQt5.sipsimplewrapper):
    ...
    def attributeDecl(
        self,
        eName: typing.Optional[str],
        aName: typing.Optional[str],
        type: typing.Optional[str],
        valueDefault: typing.Optional[str],
        value: typing.Optional[str],
    ) -> bool: ...
