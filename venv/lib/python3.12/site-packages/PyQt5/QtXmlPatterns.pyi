...
class QAbstractXmlReceiver(PyQt5.sipsimplewrapper):
    ...
    def processingInstruction(
        self, target: "QXmlName", value: typing.Optional[str]
    ) -> None: ...
...
class QXmlSerializer(QAbstractXmlReceiver):
    def __init__(
        self, query: "QXmlQuery", outputDevice: typing.Optional[QtCore.QIODevice]
    ) -> None: ...
    ...
    def atomicValue(self, value: typing.Any) -> None: ...
    def processingInstruction(
        self, name: "QXmlName", value: typing.Optional[str]
    ) -> None: ...
    def attribute(self, name: "QXmlName", value: str) -> None: ...
    def endElement(self) -> None: ...
    def startElement(self, name: "QXmlName") -> None: ...
...
class QXmlName(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def fromClarkName(
        clarkName: typing.Optional[str], namePool: "QXmlNamePool"
    ) -> "QXmlName": ...
    @staticmethod
...
class QXmlQuery(PyQt5.sipsimplewrapper):
    ...
    def setNetworkAccessManager(
        self, newManager: typing.Optional[QtNetwork.QNetworkAccessManager]
    ) -> None: ...
    ...
    def setUriResolver(
        self, resolver: typing.Optional[QAbstractUriResolver]
    ) -> None: ...
    ...
    @typing.overload
    def bindVariable(
        self, name: QXmlName, a1: typing.Optional[QtCore.QIODevice]
    ) -> None: ...
    @typing.overload
    def bindVariable(self, name: QXmlName, query: "QXmlQuery") -> None: ...
    @typing.overload
    def bindVariable(
        self, localName: typing.Optional[str], value: QXmlItem
    ) -> None: ...
    @typing.overload
    def bindVariable(
        self, localName: typing.Optional[str], a1: typing.Optional[QtCore.QIODevice]
    ) -> None: ...
    @typing.overload
    def bindVariable(
        self, localName: typing.Optional[str], query: "QXmlQuery"
    ) -> None: ...
    def namePool(self) -> QXmlNamePool: ...
    @typing.overload
    def setQuery(
        self, sourceCode: typing.Optional[str], documentUri: QtCore.QUrl = ...
    ) -> None: ...
    @typing.overload
    def setQuery(
        self,
        sourceCode: typing.Optional[QtCore.QIODevice],
    ...
    def setMessageHandler(
        self, messageHandler: typing.Optional[QAbstractMessageHandler]
    ) -> None: ...
...
class QXmlSchema(PyQt5.sipsimplewrapper):
    ...
    def setNetworkAccessManager(
        self, networkmanager: typing.Optional[QtNetwork.QNetworkAccessManager]
    ) -> None: ...
    def uriResolver(self) -> typing.Optional[QAbstractUriResolver]: ...
    def setUriResolver(
        self, resolver: typing.Optional[QAbstractUriResolver]
    ...
    def messageHandler(self) -> typing.Optional[QAbstractMessageHandler]: ...
    def setMessageHandler(
        self, handler: typing.Optional[QAbstractMessageHandler]
    ) -> None: ...
    ...
    @typing.overload
    def load(
        self, source: typing.Optional[QtCore.QIODevice], documentUri: QtCore.QUrl = ...
    ) -> bool: ...
    @typing.overload
    def load(
        self,
