...
class QHelpEngineCore(QtCore.QObject):
    ...
    def files(
        ...
        filterAttributes: typing.Iterable[typing.Optional[str]],
    ...
    def filterAttributeSets(
        self, namespaceName: typing.Optional[str]
    ...
    def filterAttributes(
        self, filterName: typing.Optional[str]
    ) -> typing.List[str]: ...
    def addCustomFilter(
        self,
        filterName: typing.Optional[str],
        attributes: typing.Iterable[typing.Optional[str]],
    ) -> bool: ...
...
class QHelpFilterData(PyQt5.sipsimplewrapper):
    ...
    def setComponents(
        self, components: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
...
class QHelpSearchQuery(PyQt5.sipsimplewrapper):
    ...
    def __init__(
        ...
        wordList: typing.Iterable[typing.Optional[str]],
    ) -> None: ...
    @typing.overload
