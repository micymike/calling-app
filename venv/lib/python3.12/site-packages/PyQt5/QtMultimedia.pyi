...
class QAbstractVideoBuffer(PyQt5.sipsimplewrapper):
    ...
    def map(
        ...
        PyQt5.sip.voidptr, typing.Optional[int], typing.Optional[int]
    ]: ...
...
class QVideoFilterRunnable(PyQt5.sipsimplewrapper):
    ...
    def run(
        self,
        input: typing.Optional["QVideoFrame"],
...
class QMediaObject(QtCore.QObject):
    def __init__(
        ...
        service: typing.Optional["QMediaService"],
    ) -> None: ...
...
class QAudioDecoder(QMediaObject):
    ...
    def hasSupport(
        ...
        codecs: typing.Iterable[typing.Optional[str]] = ...,
...
class QAudioEncoderSettingsControl(QMediaControl):
    ...
    ) -> typing.Tuple[typing.List[int], typing.Optional[bool]]: ...
...
class QMediaRecorder(QtCore.QObject, QMediaBindableInterface):
    ...
    def __init__(
        self,
        mediaObject: typing.Optional[QMediaObject],
        parent: typing.Optional[QtCore.QObject] = ...,
    ) -> None: ...
    def setMediaObject(self, object: typing.Optional[QMediaObject]) -> bool: ...
    availabilityChanged: typing.ClassVar[QtCore.pyqtSignal]
    ...
    ) -> typing.Tuple[typing.List[float], typing.Optional[bool]]: ...
    def supportedResolutions(
        self, settings: "QVideoEncoderSettings" = ...
    ) -> typing.Tuple[typing.List[QtCore.QSize], typing.Optional[bool]]: ...
...
class QCamera(QMediaObject):
    ...
    @typing.overload
    def setViewfinder(
        self, viewfinder: typing.Optional[QGraphicsVideoItem]
    ) -> None: ...
    @typing.overload
    def setViewfinder(
        self, surface: typing.Optional[QAbstractVideoSurface]
    ) -> None: ...
...
class QCameraExposure(QtCore.QObject):
    ...
    def supportedShutterSpeeds(
        self,
    ) -> typing.Tuple[typing.List[float], typing.Optional[bool]]: ...
    def supportedApertures(
        self,
    ) -> typing.Tuple[typing.List[float], typing.Optional[bool]]: ...
    def supportedIsoSensitivities(
        self,
    ) -> typing.Tuple[typing.List[int], typing.Optional[bool]]: ...
...
class QCameraExposureControl(QMediaControl):
    class ExposureParameter(int):
        ...
        ExtendedExposureParameter = (
            ...
        )  # type: QCameraExposureControl.ExposureParameter
    ...
    def supportedParameterRange(
        self, parameter: "QCameraExposureControl.ExposureParameter"
    ) -> typing.Tuple[typing.List[typing.Any], typing.Optional[bool]]: ...
...
class QCameraFeedbackControl(QMediaControl):
    ...
    def setEventFeedbackSound(
        self, a0: "QCameraFeedbackControl.EventType", filePath: typing.Optional[str]
    ) -> bool: ...
    ...
    def isEventFeedbackEnabled(
        self, a0: "QCameraFeedbackControl.EventType"
    ) -> bool: ...
...
class QCameraImageProcessingControl(QMediaControl):
    class ProcessingParameter(int):
        WhiteBalancePreset = (
            ...
        )  # type: QCameraImageProcessingControl.ProcessingParameter
        ColorTemperature = (
            ...
        )  # type: QCameraImageProcessingControl.ProcessingParameter
...
class QCameraViewfinderSettingsControl(QMediaControl):
    class ViewfinderParameter(int):
        ...
        PixelAspectRatio = (
            ...
        )  # type: QCameraViewfinderSettingsControl.ViewfinderParameter
        MinimumFrameRate = (
            ...
        )  # type: QCameraViewfinderSettingsControl.ViewfinderParameter
        MaximumFrameRate = (
...
class QMediaContent(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, playlist: typing.Optional["QMediaPlaylist"], contentUrl: QtCore.QUrl = ...
    ) -> None: ...
...
class QAudioEncoderSettings(PyQt5.sipsimplewrapper):
    ...
    def setEncodingOption(
        self, option: typing.Optional[str], value: typing.Any
    ) -> None: ...
...
class QMediaPlayer(QMediaObject):
    ...
    @typing.overload
    def setVideoOutput(
        self, surfaces: typing.Iterable[QAbstractVideoSurface]
    ) -> None: ...
    @staticmethod
...
class QMediaPlaylist(QtCore.QObject, QMediaBindableInterface):
    ...
    @typing.overload
    def save(
        self, location: QtCore.QUrl, format: typing.Optional[str] = ...
    ) -> bool: ...
    @typing.overload
    def save(
    ...
    @typing.overload
    def insertMedia(
        self, index: int, items: typing.Iterable[QMediaContent]
    ) -> bool: ...
    @typing.overload
...
class QMediaResource(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, url: QtCore.QUrl, mimeType: typing.Optional[str] = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self, request: QtNetwork.QNetworkRequest, mimeType: typing.Optional[str] = ...
    ) -> None: ...
    @typing.overload
...
class QVideoFrame(PyQt5.sipsimplewrapper):
    ...
    def __init__(
        self,
        buffer: typing.Optional[QAbstractVideoBuffer],
        size: QtCore.QSize,
...
class QVideoSurfaceFormat(PyQt5.sipsimplewrapper):
    ...
    def setScanLineDirection(
        self, direction: "QVideoSurfaceFormat.Direction"
    ) -> None: ...
