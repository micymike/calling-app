...
class QQmlEngine(QJSEngine):
    ...
    def setObjectOwnership(
        a0: typing.Optional[QtCore.QObject], a1: "QQmlEngine.ObjectOwnership"
    ) -> None: ...
    @staticmethod
    ...
    def importPlugin(
        ...
        errors: typing.Optional[typing.Iterable["QQmlError"]],
    ) -> bool: ...
    def addNamedBundle(
        self, name: typing.Optional[str], fileName: typing.Optional[str]
    ) -> bool: ...
    def addPluginPath(self, dir: typing.Optional[str]) -> None: ...
    def setPluginPathList(
        self, paths: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
...
class QQmlFileSelector(QtCore.QObject):
    ...
    def setExtraSelectors(
        self, strings: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
