...
class QDBusAbstractInterface(QtCore.QObject):
    ...
    def asyncCallWithArgumentList(
        self, method: typing.Optional[str], args: typing.Iterable[typing.Any]
    ) -> "QDBusPendingCall": ...
    def asyncCall(
        self,
...
class QDBusConnection(PyQt5.sipsimplewrapper):
    ...
    def disconnect(
        ...
        interface: typing.Optional[str],
        name: typing.Optional[str],
        argumentMatch: typing.Iterable[typing.Optional[str]],
        signature: typing.Optional[str],
        slot: PYQT_SLOT,
    ) -> bool: ...
    @typing.overload
...
class QDBusServiceWatcher(QtCore.QObject):
    ...
    def setWatchedServices(
        self, services: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
