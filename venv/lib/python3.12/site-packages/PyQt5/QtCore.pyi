...
class QObject(PyQt5.sip.wrapper):
    ...
    def findChildren(
        self,
        types: typing.Tuple[typing.Type[QObjectT], ...],
        name: typing.Optional[str] = ...,
        options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...,
    ) -> typing.List[QObjectT]: ...
    @typing.overload
...
class QAbstractEventDispatcher(QObject):
    ...
    def unregisterSocketNotifier(
        self, notifier: typing.Optional["QSocketNotifier"]
    ) -> None: ...
...
class QAbstractItemModel(QObject):
    ...
    def mimeData(
        self, indexes: typing.Iterable[QModelIndex]
...
class QByteArray(PyQt5.sipsimplewrapper):
    ...
    def __add__(
        self, a2: typing.Union["QByteArray", bytes, bytearray]
    ) -> "QByteArray": ...
    @staticmethod
...
class QCborStreamWriter(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, data: typing.Optional[typing.Union[QByteArray, bytes, bytearray]]
    ) -> None: ...
...
class QCommandLineOption(PyQt5.sipsimplewrapper):
    ...
    def __init__(
        self,
        names: typing.Iterable[typing.Optional[str]],
        description: typing.Optional[str],
        valueName: typing.Optional[str] = ...,
        defaultValue: typing.Optional[str] = ...,
    ) -> None: ...
    ...
    def setDefaultValues(
        self, defaultValues: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
...
class QDataStream(PyQt5.sipsimplewrapper):
    ...
    def writeBytes(
        self, a0: typing.Optional[PyQt5.sip.array[bytes]]
    ) -> "QDataStream": ...
    def readRawData(self, len: int) -> bytes: ...
    def readBytes(self) -> bytes: ...
    def writeQVariantHash(
        self, qvarhash: typing.Dict[typing.Optional[str], typing.Any]
    ) -> None: ...
    ...
    def writeQStringList(
        self, qstrlst: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
...
class QDate(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def fromString(
        s: typing.Optional[str], format: typing.Optional[str], cal: QCalendar
    ) -> "QDate": ...
    @staticmethod
...
class QDir(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def setSearchPaths(
        prefix: typing.Optional[str], searchPaths: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def match(
        filters: typing.Iterable[typing.Optional[str]], fileName: typing.Optional[str]
    ) -> bool: ...
    @typing.overload
    @staticmethod
    ...
    def setNameFilters(
        self, nameFilters: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
...
class QDirIterator(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, path: typing.Optional[str], flags: "QDirIterator.IteratorFlags" = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QFileDevice(QIODevice):
    ...
    ) -> typing.Optional[PyQt5.sip.voidptr]: ...
    def setPermissions(
        self,
...
class QFileSelector(QObject):
    ...
    def setExtraSelectors(
        self, list: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
...
class QFileSystemWatcher(QObject):
    ...
    def __init__(
        self,
        paths: typing.Iterable[typing.Optional[str]],
        parent: typing.Optional[QObject] = ...,
    ) -> None: ...
    ...
    def removePaths(
        self, files: typing.Iterable[typing.Optional[str]]
    ) -> typing.List[str]: ...
    ...
    def __init__(
        ...
        object: typing.Dict[
            ...
            typing.Union[
                ...
                typing.Dict[typing.Optional[str], "QJsonValue"],
                bool,
                int,
                float,
                None,
...
class QLineF(PyQt5.sipsimplewrapper):
    ...
    def intersects(
        self, l: "QLineF"
    ) -> typing.Tuple["QLineF.IntersectType", typing.Optional["QPointF"]]: ...
    def intersect(
        self,
        l: "QLineF",
        intersectionPoint: typing.Optional[typing.Union["QPointF", "QPoint"]],
...
class QLocale(PyQt5.sipsimplewrapper):
    ...
    def quoteString(
        self, str: typing.Optional[str], style: "QLocale.QuotationStyle" = ...
    ) -> str: ...
    @staticmethod
    def matchingLocales(
        language: "QLocale.Language",
    ...
    def toCurrencyString(
        self, value: float, symbol: typing.Optional[str] = ...
    ) -> str: ...
    @typing.overload
    def toCurrencyString(
        self, value: float, symbol: typing.Optional[str], precision: int
    ) -> str: ...
    @typing.overload
    def toCurrencyString(
    ...
    @typing.overload
    def toDateTime(
        self, string: typing.Optional[str], format: "QLocale.FormatType", cal: QCalendar
    ) -> QDateTime: ...
    @typing.overload
    def toDateTime(
        self, string: typing.Optional[str], format: typing.Optional[str], cal: QCalendar
    ) -> QDateTime: ...
    @typing.overload
    def toTime(
        self, string: typing.Optional[str], format: "QLocale.FormatType" = ...
    ...
    @typing.overload
    def toString(
        self, date: typing.Union[QDate, datetime.date], formatStr: typing.Optional[str]
    ) -> str: ...
    @typing.overload
    def toString(
        self,
    ...
    @typing.overload
    def toString(
        self, time: typing.Union[QTime, datetime.time], formatStr: typing.Optional[str]
    ) -> str: ...
    @typing.overload
    def toString(
        self,
...
class QMimeData(QObject):
    def __init__(self) -> None: ...
    def retrieveData(
        self, mimetype: typing.Optional[str], preferredType: "QVariant.Type"
    ) -> typing.Any: ...
...
class QProcess(QIODevice):
    ...
    def setArguments(
        self, arguments: typing.Iterable[typing.Optional[str]]
    ) -> None: ...
    ...
    def startDetached(
        ...
        arguments: typing.Iterable[typing.Optional[str]],
        workingDirectory: typing.Optional[str],
    ) -> typing.Tuple[bool, typing.Optional[int]]: ...
    @typing.overload
    @staticmethod
    def startDetached(
        program: typing.Optional[str], arguments: typing.Iterable[typing.Optional[str]]
    ) -> bool: ...
    @typing.overload
    @staticmethod
...
class QRunnable(PyQt5.sip.wrapper):
    ...
    @staticmethod
    def create(
        functionToRun: typing.Callable[[], None],
...
class QSettings(QObject):
    ...
    def beginWriteArray(
        self, prefix: typing.Optional[str], size: int = ...
    ) -> None: ...
...
class QSignalMapper(QObject):
    ...
    @typing.overload
    def setMapping(
        self, sender: typing.Optional[QObject], widget: typing.Optional[QWidget]
    ) -> None: ...
    @typing.overload
    def setMapping(
...
class QStateMachine(QState):
    ...
    def start(self) -> None: ...
    def eventFilter(
        self, watched: typing.Optional[QObject], event: typing.Optional[QEvent]
    ) -> bool: ...
...
class QTextCodec(PyQt5.sip.wrapper):
    ...
    def convertFromUnicode(
        self,
        in_: typing.Optional[PyQt5.sip.array[str]],
        state: typing.Optional["QTextCodec.ConverterState"],
    ) -> QByteArray: ...
    def convertToUnicode(
        self,
        in_: typing.Optional[PyQt5.sip.array[bytes]],
        state: typing.Optional["QTextCodec.ConverterState"],
    ) -> str: ...
    ...
    ) -> typing.Optional["QTextEncoder"]: ...
    def makeDecoder(
        self,
        flags: typing.Union[
            "QTextCodec.ConversionFlags", "QTextCodec.ConversionFlag"
        ] = ...,
    ) -> typing.Optional["QTextDecoder"]: ...
    @staticmethod
    ...
    ) -> typing.Optional["QTextCodec"]: ...
    @typing.overload
    @staticmethod
    def codecForUtfText(
        ba: typing.Union[QByteArray, bytes, bytearray],
        defaultCodec: typing.Optional["QTextCodec"],
    ) -> typing.Optional["QTextCodec"]: ...
    @typing.overload
    @staticmethod
    def codecForHtml(
...
class QTextEncoder(PyQt5.sip.wrapper):
    ...
    def __init__(
        self,
        codec: typing.Optional[QTextCodec],
...
class QTextStream(PyQt5.sipsimplewrapper):
    ...
    def __init__(
        self,
        array: typing.Optional[QByteArray],
        mode: typing.Union[QIODevice.OpenMode, QIODevice.OpenModeFlag] = ...,
    ) -> None: ...
    def locale(self) -> QLocale: ...
    def setLocale(self, locale: QLocale) -> None: ...
...
class QTranslator(QObject):
    ...
    def loadFromData(
        self,
        data: typing.Optional[PyQt5.sip.array[bytes]],
...
class QUrl(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def fromStringList(
        uris: typing.Iterable[typing.Optional[str]], mode: "QUrl.ParsingMode" = ...
    ) -> typing.List["QUrl"]: ...
    @staticmethod
    def toStringList(
...
class QWaitCondition(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def wait(
        self, readWriteLock: typing.Optional[QReadWriteLock], msecs: int = ...
    ) -> bool: ...
    @typing.overload
    def wait(
        self,
...
class QXmlStreamAttributes(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def hasAttribute(
        self, namespaceUri: typing.Optional[str], name: typing.Optional[str]
    ) -> bool: ...
    @typing.overload
    def append(
        self,
...
class QXmlStreamWriter(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, array: typing.Optional[typing.Union[QByteArray, bytes, bytearray]]
    ) -> None: ...
    def hasError(self) -> bool: ...
    ...
    def writeStartDocument(
        self, version: typing.Optional[str], standalone: bool
    ) -> None: ...
    ...
    def writeNamespace(
        self, namespaceUri: typing.Optional[str], prefix: typing.Optional[str] = ...
    ) -> None: ...
    ...
    def writeTextElement(
        self, qualifiedName: typing.Optional[str], text: typing.Optional[str]
    ) -> None: ...
    @typing.overload
    def writeTextElement(
        self,
...
def qInstallMessageHandler(
    a0: typing.Optional[
        typing.Callable[[QtMsgType, QMessageLogContext, typing.Optional[str]], None]
    ],
) -> typing.Optional[
    typing.Callable[[QtMsgType, QMessageLogContext, typing.Optional[str]], None]
]: ...
...
@typing.overload
def qChecksum(
    s: typing.Optional[PyQt5.sip.array[bytes]], standard: Qt.ChecksumType
) -> int: ...
